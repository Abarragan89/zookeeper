...
const handleAnimalFormSubmit = event => {
  ...
  // need to specifically put POST because fetch are by default GET requests
  // this fetch is the request object that gets send. We build the request object here and it will be broken apart in our app.post method. 
  fetch('/api/animals', {
    method: 'POST',
    headers: {
